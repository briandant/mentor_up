...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_user', 'teach',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TeachSkills'], null=True),
                      keep_default=False)

        # Adding field 'User.learn'
        db.add_column(u'users_user', 'learn',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.LearnSkills'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.user': {
            ...
            'learn': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.LearnSkills']", 'null': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'short_bio': ('django.db.models.fields.TextField', [], {}),
            'teach': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TeachSkills']", 'null': 'True'}),
