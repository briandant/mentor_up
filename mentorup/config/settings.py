# -*- coding: utf-8 -*-
"""
Django settings for mentorup project.
...
class Common(Configuration):
    ...
    ADMINS = (
        ('Nate Aune, Brian Dant, Chris Van Schyndel', 'natejaune@gmail.com'),
    )
...
class Production(Common):
    ...
    EMAIL_SUBJECT_PREFIX = values.Value('[mentorup] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
